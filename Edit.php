                ...
                <form method="POST" action="EditData.php?id=<?php echo $row['id']?>">
                    <div class="form-group">
                        ...
                        <input type="text" name="hari" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" value="<?php echo $row['hari']?>">
                    </div>
                    <div class="form-group">
